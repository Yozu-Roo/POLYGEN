...
from .scoring_function import MoleculewiseScoringFunction
from .scoring_function import ScoringFunctionBasedOnRdkitMol
from .scoring_function import ArithmeticMeanScoringFunction
from .scoring_function import MinMaxGaussianModifier
from .scoring_function import ThresholdedLinearModifier
from .scoring_function import SegmentLinearThresholdModifier
from .scoring_function import LinearModifier

# custom scoring
from .custom_scoring_fcn import QED_custom, BindingScorer_Custom
from .custom_scoring_fcn import SAScorer
from .custom_scoring_fcn import CellLine
from .custom_scoring_fcn import LatentDistance
from .custom_scoring_fcn import LogP
from .custom_scoring_fcn import MW
from .custom_scoring_fcn import TaniSim
from .custom_scoring_fcn import LigandEfficancy
from .custom_scoring_fcn import BindingScorer
...
def build_scoring_function(scoring_definition,
    ...
    for i, row in df.iterrows():
        ...
        elif row.category == 'ligand_binding':
            scorers[name] = BindingScorer_Custom(
                score_modifier=LinearModifier(),
                model_path=row.file
            )
        else:
    ...
    scoring_function = ArithmeticMeanScoringFunction([scorers[i] for i in scorers],weights=weights)
